...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="create_vehicule_user.php" class="btn btn-primary">Ajouter un véhicule</a>
            ...
            <tbody>
                <?php foreach ($vehicules as $vehicule): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_vehicule_user.php?id=<?php echo $vehicule->getId(); ?>" class="btn btn-primary btn-sm">Modifier</a>
                            <a href="delete_vehicule_user.php?id=<?php echo $vehicule->getId(); ?>" class="btn btn-danger btn-sm">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
