...
<head>
    ...
    <title>Supprimer un témoignage</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container mt-4">
        ...
        // Vérification de l'ID du témoignage à supprimer
        ...
        // Récupération des détails du témoignage
        $testimonialId = $_GET['id'];
        $testimonial = $testimonialsController->getTestimonial($testimonialId);

        // Si le témoignage n'existe pas, rediriger vers la liste
        if (!$testimonial) {
            header("Location: list_testimonials.php");
            exit;
        }

        // Traitement de la suppression du témoignage
        if (isset($_POST['delete'])) {
            if ($testimonialsController->deleteTestimonial($testimonialId)) {
                header("Location: list_testimonials.php");
                exit;
            }
        }
        ?>
        <h1 class= "mb-4">Supprimer un témoignage</h1>
        ...
        <form action="" method="POST">
            ...
            <a href="list_testimonials.php" class="btn btn-secondary mb-4">Annuler</a>
        </form>
        <form action="list_testimonials.php" method="GET">
            <button type="submit" class="btn btn-success mb-4">Retourner à la liste des témoignages</button>
        </form>
    </div>
    <footer class="mt-4">
        <div class="container">
