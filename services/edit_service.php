...
// Vérification de l'ID du service à éditer
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Éditer un service</h1>
        <form action="process_edit_service.php" method="POST">
            <input type="hidden" name="service_id" value="<?php echo $service->getId(); ?>">
            <div class="mb-3">
                <label for="nom" class="form-label">Nom</label>
                <input type="text" class="form-control" id="nom" name="nom" value="<?php echo $service->getNom(); ?>" required>
            </div>
            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <textarea class="form-control" id="description" name="description" rows="4"><?php echo $service->getDescription(); ?></textarea>
            </div>
